            ...
            <div className='col-lg-4 col-md-12 col-12'>
              <div className='widget widget-logo'>
                <div className='logo-footer' id='logo-footer'>
                  <Link to='/'>
                    <img className='logo-dark' id='logo_footer' src={logoIcon} alt='nft-gaming' />
                    <img
                ...
                <p className='sub-widget-logo'>User Focused NFT Launchpad for SUI Network</p>
              </div>
            </div>
